...
export type { DashboardResponse, DailySalesPoint, DashboardCompanyOption, DashboardAnalytics, MonthPoint, CashFlowPoint, AgeingBucket, CustomerShare, SalesMix, Trend } from "@smartnet/api-client";
